  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-6 pt-10">
      ...
      <div className="relative z-10 text-center max-w-4xl">
        ...
        <h1 className="mt-6 text-3xl sm:text-3xl md:text-5xl lg:text-6xl md:leading-[1.2] font-semibold tracking-tighter">
        ...
        {/* <p className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl md:leading-[1.2] font-semibold tracking-tighter underline"> */}
        {/*   Relevant */}
        {/* </p> */}
